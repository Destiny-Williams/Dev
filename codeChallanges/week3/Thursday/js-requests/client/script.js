...
let sayHelloButtonNightMode = (event) => {
    event.target.style.backgroundColor = "Black";
    event.target.style.color = "White";
}
sayHelloButton.addEventListener("mouseover", sayHelloButtonNightMode);

// let sayHelloButtonNightMode = (event) => {     event.target.style.backgroundColor = 'Black';     event.target.style.color = 'White'      } sayHelloButton.addEventListener("mouseover", sayHelloButtonNightMode)
...
// CODE HERE
const getRequest = () => {
    axios.get('http://localhost:3000/guery-test?WUT')
