...
let nameGreeting = nameCheck("Destiny");
...
// to check run  a console.log(oddChecker)
...
// to check run console.log(arrayEvaluator)
...
function frogsForGold(gold){
  chocolateFrogs = 3;
  return gold / chocolateFrogs;
  
}
let totalFrogs = frogsForGold(3);
...
//CODE HERE
function frogsForGold2(gold){
  chocolateFrogs = 3;
  return Math.floor( gold / chocolateFrogs);
}
let totalFrogs2 = frogsForGold2(4);
...
console.log(ascendingArr(sampleArray));
